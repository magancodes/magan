...
const ROLES: Role[] = [
  {
    ...
    place: "india",
    bullets: [
      "standing up a new pw vertical: data for ai — sourcing, ops, and commercialisation of training data from india.",
      "owning growth and gtm for data ops: ICP, packaging, outbound, and the motion that turns lab capacity into paid contracts.",
      "selling into labs and data buyers — pitching supply, closing loops on quality / delivery, and proving the india wedge works.",
      "building the playbook from zero inside physicswallah so the vertical can scale beyond founder-led deals.",
    ],
  },
  {
  ...
  },
  {
    ...
    place: "remote",
    bullets: [
      "built semantic search across a corpus of 2m+ ingested videos: embed each asset, retrieve by cosine similarity, then rerank so the UI surfaces the closest matches — not keyword hits.",
